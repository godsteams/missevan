<template>
    <div >
        ...
        <div
            ...
            :key='li.id'
        >   <!-- 锚点 -->
            <h6 :id="li.catalog_name_alias"><b></b>{{li.catalog_name}}<span>更多<i></i></span></h6>
...
.clearfloat:after{
    ...
    .intro{
        height: 70px;margin: 0px 15px;border-bottom:0.2px solid #E9E9E9;padding: 15px 0;
    }
    .intro img{
        width: 70px;height: 70px;border-radius: 8px;margin-right: 10px;
    }
    .intro p{
    ...
    .intro span:nth-of-type(1){
     ...
     span i{
        display: inline-block;width:12px;height:12px;background-image: url(../assets/img/mini.png);
        background-size:56px;background-position:-44px 27px;vertical-align: middle;margin-right: 5px;
    }
    .intro div span{
        margin-right: 20px;
    }
    ...
    h6{
        line-height: 20px;margin: 10px 0;padding: 0 15px;font-size: 16px;
    }
    h6 span{
        float: right;color: #E9E9E9;font-size: 13px;vertical-align:baseline
    }
    h6 span i{
         background-image: url(../assets/img/xiebi.png);  background-size:261px 235px;
         background-position:-223px -186px;width: 16px;height: 16px;margin-left: 5px;        
    }
    b{
        display: inline-block;width: 4px;height:16px;background: #000000;vertical-align: middle;margin-right: 5px;
    }
</style>
